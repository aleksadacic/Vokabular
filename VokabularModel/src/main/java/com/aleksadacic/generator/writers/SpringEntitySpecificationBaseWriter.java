...
public class SpringEntitySpecificationBaseWriter extends JavaClassWriter {
    ...
    public void writeClassContent() {
        append(1, "private Specification<" + modelObject.getName() + "> specification;");
        appendBlankLine();
        ...
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification and(BusinessAttribute key, Object value) {");
        ...
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification and(BusinessAttribute key, SearchOperator operation, Object value) {");
        append(2, "specification = specification.and(new BusinessSpecification<>(new Filter(key, operation, value)));");
        append(2, "return (" + modelObject.getName() + "Specification) this;");
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification and(" + modelObject.getName() + "Specification userSpec) {");
        append(2, "specification = specification.and(userSpec.getSpecification());");
        append(2, "return (" + modelObject.getName() + "Specification) this;");
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification or(BusinessAttribute key, Object value) {");
        append(2, "specification = specification.or(new BusinessSpecification<>(new Filter(key, value)));");
        append(2, "return (" + modelObject.getName() + "Specification) this;");
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification or(BusinessAttribute key, SearchOperator operation, Object value) {");
        append(2, "specification = specification.or(new BusinessSpecification<>(new Filter(key, operation, value)));");
        append(2, "return (" + modelObject.getName() + "Specification) this;");
        append(1, "}");
        appendBlankLine();
        append(1, "public " + modelObject.getName() + "Specification or(" + modelObject.getName() + "Specification userSpec) {");
